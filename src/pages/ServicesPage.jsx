      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h2 className="font-display text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Exceptional Services for <span className="gradient-text block">Every Occasion</span>
          </h2>
        ...
        {/* Main Services */}
        <section ref={servicesRef} className="space-y-20">
        ...
        {/* Additional Services */}
        <section className="mt-20 py-16 bg-gray-50 rounded-lg">
